...
pub mod kyogen {
    ...
    pub fn init_map(ctx: Context<InitMap>, entity_id:u64, max_x:u8, max_y:u8) -> Result<()> {
        ...
        components.insert(kyogen_ref.metadata.key(), SerializedComponent { 
        ...
        let mapmeta_component = ComponentMapMeta {
            max_x,
            max_y,
            game_status: PlayPhase::Lobby,
        }.try_to_vec().unwrap();
        components.insert(kyogen_ref.mapmeta.key(), SerializedComponent { 
    ...
    pub fn init_tile(ctx:Context<InitTile>, entity_id:u64, x:u8, y:u8, spawnable: bool, spawn_cost: u64, clan: Option<Clans>) -> Result<()> {
        ...
        components.insert(kyogen_ref.location.key(), SerializedComponent { 
        ...
        components.insert(kyogen_ref.occupant.key(), SerializedComponent { 
        ...
        components.insert(kyogen_ref.spawn.key(), SerializedComponent { 
    ...
    pub fn init_player(ctx:Context<InitPlayer>, entity_id:u64, name:String, clan: Clans) -> Result<()> {
        ...
        components.insert(kyogen_ref.player_stats.key(), SerializedComponent { 
    ...
    pub fn claim_spawn(ctx:Context<ClaimSpawn>) -> Result<()> {
        ...
        // Check that the 
            // Tile has a Unit
        let unit_c = ctx.accounts.tile_entity.components.get(&kyogen_ref.occupant).unwrap();
        ...
        let owner_c = ctx.accounts.unit_entity.components.get(&kyogen_ref.owner).unwrap();
        ...
        let spawn_c = ctx.accounts.tile_entity.components.get(&kyogen_ref.spawn).unwrap();
        ...
        let player_stats_c = ctx.accounts.player_entity.components.get(&kyogen_ref.player_stats).unwrap();
        ...
        registry::cpi::req_modify_component(modify_tile_ctx, vec![(kyogen_ref.spawn, spawn_component.try_to_vec().unwrap())])?;
    ...
    pub fn spawn_unit(ctx:Context<SpawnUnit>, unit_id:u64) -> Result<()> {
        ...
        let player_stats_component = ctx.accounts.player.components.get(&kyogen_ref.player_stats).unwrap();
        ...
        let tile_occupant_component = ctx.accounts.tile.components.get(&kyogen_ref.occupant).unwrap();
        ...
        let tile_spawnable_component = ctx.accounts.tile.components.get(&kyogen_ref.spawn).unwrap();
        ...
        components.insert(kyogen_ref.owner.key(), SerializedComponent {
        ...
        components.insert(kyogen_ref.active.key(), SerializedComponent{
        ...
        components.insert(
            kyogen_ref.location.key(),
            ctx.accounts.tile.components.get(&kyogen_ref.location).unwrap().clone()
        );
        ...
        registry::cpi::req_modify_component(modify_tile_ctx, vec![(kyogen_ref.occupant, tile_occupant.try_to_vec().unwrap())])?;
        ...
        registry::cpi::req_modify_component(modify_player_ctx, vec![(kyogen_ref.player_stats, player_stats.try_to_vec().unwrap())])?;
    ...
    pub fn move_unit(ctx:Context<MoveUnit>) -> Result<()> {
        ...
        let from_occupant_c = ctx.accounts.from.components.get(&kyogen_ref.occupant).unwrap();
        ...
        let unit_owner_c = ctx.accounts.unit.components.get(&kyogen_ref.owner).unwrap();
        ...
        let to_occupant_c = ctx.accounts.to.components.get(&kyogen_ref.occupant).unwrap();
        ...
        let unit_last_used_c = ctx.accounts.unit.components.get(&kyogen_ref.last_used).unwrap();
        ...
        let from_location_c = ctx.accounts.from.components.get(&kyogen_ref.location).unwrap();
        let from_location = ComponentLocation::try_from_slice(&from_location_c.data.as_slice()).unwrap();

        let to_location_c = ctx.accounts.to.components.get(&kyogen_ref.location).unwrap();
        ...
        let unit_range_component = ctx.accounts.unit.components.get(&kyogen_ref.range).unwrap();
        ...
        registry::cpi::req_modify_component(modify_unit_ctx, vec![
            ...
            (kyogen_ref.location, to_location.try_to_vec().unwrap())  // Location
        ])?;
    ...
    pub fn attack_unit(ctx: Context<AttackUnit>) -> Result<()> {
        ...
        let attacker_owner_c = attacker.components.get(&kyogen_ref.owner).unwrap();
        ...
        let defender_owner_c = defender.components.get(&kyogen_ref.owner).unwrap();
        ...
        let attacker_active_c = attacker.components.get(&kyogen_ref.active).unwrap();
        let attacker_active = ComponentActive::try_from_slice(&attacker_active_c.data.as_slice()).unwrap();
        let defender_active_c = defender.components.get(&kyogen_ref.active).unwrap();
        ...
        let tile_occupant_c = tile.components.get(&kyogen_ref.occupant).unwrap();
        ...
        let attacker_location_c = attacker.components.get(&kyogen_ref.location).unwrap();
        let attacker_location = ComponentLocation::try_from_slice(&attacker_location_c.data.as_slice()).unwrap();
        let defender_location_c = defender.components.get(&kyogen_ref.location).unwrap();
        ...
        let attacker_range_c = attacker.components.get(&kyogen_ref.range).unwrap();
        ...
        let clock = Clock::get().unwrap();
        let attacker_last_used_c = attacker.components.get(&kyogen_ref.last_used).unwrap();
        ...
        let attacker_damage_c = attacker.components.get(&kyogen_ref.damage).unwrap();
        let attacker_damage = ComponentDamage::try_from_slice(&attacker_damage_c.data.as_slice()).unwrap();

        let defender_health_c = defender.components.get(&kyogen_ref.health);
        ...
        let defender_troop_class_c = defender.components.get(&kyogen_ref.troop_class).unwrap();
        ...
        if dmg >= defender_health.health {
            ...
            registry::cpi::req_modify_component(modify_tile_ctx, vec![
                (kyogen_ref.occupant, tile_occupant.try_to_vec().unwrap()), // Last Used
            ])?;
        ...
        registry::cpi::req_modify_component(modify_defender_ctx, vec![
            (kyogen_ref.health, defender_health.try_to_vec().unwrap()), 
            (kyogen_ref.active, defender_active.try_to_vec().unwrap()), 
        ])?;
        ...
        registry::cpi::req_modify_component(modify_attacker_ctx, vec![
            (kyogen_ref.last_used, attacker_last_used.try_to_vec().unwrap()), // Last Used
        ])?;
